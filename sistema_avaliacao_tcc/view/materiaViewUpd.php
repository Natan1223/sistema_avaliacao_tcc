      ...
      <div class="main-content">
        <div class="breadcrumbs" id="breadcrumbs">
          ...
          <ul class="breadcrumb">
            ...
            <li>
              <a href="materiaViewCon.php">Matéria</a>
            </li>
            <li class="active">Change Table Matéria</li>
          </ul><!-- .breadcrumb -->
        ...
        <div class="page-content">
          ...
          <div class="row">
            <div class="col-xs-12">
              ...
              <form class="form-horizontal" role="form" method="post" action="../control/materiaControl.php">
                <input type="hidden" name="option" value="<?php echo( $_SESSION['option'] ); ?>" />
                <div class="form-group">
                  <label class="col-sm-3 control-label no-padding-right" for="cod_materia">Código Matéria</label>
                    <!-- Here you can add a tag readonly="" do make the input readonly-->
                  <div class="col-sm-9">
                    <input readonly="true"  <?php echo($readonly); ?> value="<?php echo( $_SESSION['cod_materia'] ); ?>" type="text" name="cod_materia" id="cod_materia" placeholder="Gerado Pelo Sitema" class="col-xs-10 col-sm-5" />
                  </div>
                </div>
                <div class="space-4"></div>
                <div class="form-group">
                  <label class="col-sm-3 control-label no-padding-right" for="descrica_materia">Descrição da Materia</label>
                    <!-- Here you can add a tag readonly="" do make the input readonly-->
                  <div class="col-sm-9">
                    <input <?php echo($readonly); ?> value="<?php echo( $_SESSION['descrica_materia'] ); ?>" type="text" name="descrica_materia" id="descrica_materia" placeholder="Descrição Máteria" class="col-xs-10 col-sm-5" />
                  </div>
                </div>
                <div class="space-4"></div>
                <?php 
