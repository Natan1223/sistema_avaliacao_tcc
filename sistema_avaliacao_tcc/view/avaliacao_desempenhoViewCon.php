...
<script type="text/javascript">
  function changerecord( aux )
  {
    ...
    changeform.cod_avaliacao.value = aux;
    changeform.submit();
  }
</script>
<script type="text/javascript">
...
<form action="../control/avaliacao_desempenhoControl.php" name="changeform" method="post">
  <input type="hidden" name="option" value="" />
    <input type="hidden" name="cod_avaliacao" value="" />
</form>
      <div class="main-content">
        <div class="breadcrumbs" id="breadcrumbs">
          ...
          <ul class="breadcrumb">
            ...
            <li class="active">avaliacao_desempenho</li>
          </ul><!-- .breadcrumb -->
        ...
        <div class="page-content">
          <div class="row">
            <div class="col-xs-12">
              ...
              <div class="row">
                <div class="col-xs-12">
                  <h3 class="header smaller lighter blue">Avaliação de Desempenho</h3>
                  <p>
                    <button class="btn btn-sm btn-primary" onClick="javascript:addrecord();">Nova Avaliação</button>
                  </p>
                  <div class="table-header">
                    Avaliação de Desempenho Cadastradas:
                  </div>
                  <div class="table-responsive">
                    <table id="data-table" class="table table-striped table-bordered table-hover">
                      ...
                      <tbody>
<?php 
include_once ("../control/avaliacao_desempenhoControl.php");
